...
wordBoundary (a, b) = isAlpha a /= isAlpha b

charTransitions :: String -> [(Char, Char)]
...
numChars :: String -> Int
numChars s = (length . (filter isAlpha)) s

medellangd :: String -> Double
medellangd s = (fromIntegral . numChars) s / (fromIntegral . numWords) s
